  ...
  return (
    <>
      <div className="container mx-auto text-regal-blue">
        ...
        <p className="font-semibold text-xl mt-10">INVOICES</p>
        ...
        <div className="flex justify-start items-center mt-11">
          <button
            className=" w-60 border mt-4 justify-center p-[14px] h-12 rounded-md items-center mr-4
    
            hover:bg-regal-blue hover:text-white
             border-regal-blue text-regal-blue"
          >
            Export
          </button>

          <button className=" w-60 border hover:bg-regal-blue hover:text-white border-regal-blue mr-4 mt-4 justify-center p-[14px] h-12 rounded-md items-center ">
